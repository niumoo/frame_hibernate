			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 ">
					<div class="site-heading">
						...
						<span class="post-subheading text-left">${post.subhead }</span>
                        <span class="subheading text-left post-meta">Posted by niu on 
                            <fmt:formatDate value="${post.createTime}" pattern="MM dd,yyyy"/></span>
					</div>
				</div>
			</div>
		</div>
