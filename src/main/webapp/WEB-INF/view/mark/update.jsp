...
<script type="text/javascript">
    function update() {
        ...
        var tags = $("#tags").val();
        $.ajax({
            url : "${pageContext.request.contextPath}/mark/update", //请求的url地址
...
<div class="container">
    <div class="row">
        <div class="col-lg-12  col-md-12 text-left">
                            标题：
            <input style="width: 100%;" type="text" id="title"  value="${p.title}" class="form-control">
                             副标题：
            <input type="text" style="width: 100%;" id="subhead" value="${p.subhead}" class="form-control" >
                              摘要：
            <input style="width: 100%;" type="text" id="summary" value="${p.summary}" class="form-control" >
                                路径：
            <input style="width: 100%;" type="text" id="path"  value="${p.path}"class="form-control"  placeholder="不要以/开头">
                              标签：<br/>
            <input type="text" value="${tags}" class="form-control" id="tags" placeholder="多个标签用英文,隔开">
                              状态：
             <select class="form-control" style="width:150px" value="${p.status}" id="status">
                          <option value="1">公开展示</option>
                      <option value="0">不公开</option>
             </select>
            <br/>
            <button value="发布" onclick="update()" class="btn btn-primary">保存</button>
            ...
            testEditor = editormd(
                    "test-editormd",
                    {
                        ...
                        imageFormats : [ "jpg", "jpeg", "gif", "png", "bmp",
                                "webp" ],
                        imageUploadURL : "/mark/uploadfile",
